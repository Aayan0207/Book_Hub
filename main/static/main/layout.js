document.addEventListener("DOMContentLoaded", () => {
    ...
    readers_grove_link.onmouseenter = () => {
        ...
        readers_grove_animation = setTimeout(() => {readers_grove_image.src="/static/readers_grove/Readers Grove Post.png";}, 1350);
    }
    ...
    readers_grove_link.onclick = (event) => {
        ...
        setTimeout(() => {window.location.href="/readers_grove";}, 500);
    }
    book_crate_link.onmouseenter = () => {
        book_crate_image.src="/static/book_crate/Book crate middle.gif";
        book_crate_animation=setTimeout(() => {book_crate_image.src="/static/book_crate/Book crate final.png";}, 1700);
    }
    ...
    book_crate_link.onclick = (event) => {
        ...
        setTimeout(() => {window.location.href="/book_crate";}, 500);
    }
    codex_link.onmouseenter= () => {
        codex_image.src="/static/codex/Codex 1.gif";
        codex_animation=setTimeout(() => {codex_image.src="/static/codex/Codex 2.gif";}, 2050);
    };
